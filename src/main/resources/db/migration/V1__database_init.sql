...
(
    ...
    PERIOD_OF_STUDY_FROM                    timestamp           NOT NULL,
    PERIOD_OF_STUDY_UNTIL                   timestamp           NOT NULL,
...
CREATE TABLE STUDENT_HAS_SENDING_INSTITUTIONS
(
    STUDENT_ID             bigint NOT NULL,
    SENDING_INSTITUTION_ID bigint NOT NULL,
    FOREIGN KEY (STUDENT_ID)
        REFERENCES STUDENTS (ID),
    FOREIGN KEY (SENDING_INSTITUTION_ID)
        REFERENCES SENDING_INSTITUTIONS (ID)
);

CREATE TABLE COURSE_HAS_COORDINATORS
(
    COURSE_ID             bigint NOT NULL,
    COURSE_COORDINATOR_ID bigint NOT NULL,
    FOREIGN KEY (COURSE_ID)
        REFERENCES COURSES (ID),
    FOREIGN KEY (COURSE_COORDINATOR_ID)
        REFERENCES COURSE_COORDINATORS (ID)
);
